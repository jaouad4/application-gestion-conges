...
public class VacationRequestDAO {
    public void add(VacationRequest request) throws SQLException {
    ...
    public List<VacationRequest> getAll() throws SQLException {
    ...
    public void update(VacationRequest request) throws SQLException {
